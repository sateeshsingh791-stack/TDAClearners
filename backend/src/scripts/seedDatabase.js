 ...
 * Migrates full TDAClearners curriculum, practicals, quizzes, flashcards, careers, and resources.
 * Supports clean re-runs without duplicate creation.
...
const seedData = async () => {
  ...
  try {
    ...
    // Clear existing content collections cleanly
    ...
    console.log(`[Seed DB] Seeded ${subjectsData.length} Subjects.`);
    ...
    console.log(`[Seed DB] Seeded ${topicsData.length} Topics.`);
    ...
    await Practical.insertMany(practicalsData);
    console.log(`[Seed DB] Seeded ${practicalsData.length} Practicals.`);
    ...
    console.log(`[Seed DB] Seeded ${quizQuestionsData.length} Quiz Questions.`);
    ...
    console.log(`[Seed DB] Seeded ${flashcardsData.length} Flashcards.`);
    ...
    await CareerRole.insertMany(careersData);
